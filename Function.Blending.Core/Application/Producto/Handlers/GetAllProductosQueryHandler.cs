...
public class GetAllProductosQueryHandler : IRequestHandler<GetAllProductosQuery, PagedResponse<ProductoDTO>>
{
    ...
    public async Task<PagedResponse<ProductoDTO>> Handle(GetAllProductosQuery request, CancellationToken cancellationToken)
    {
        try
        {
