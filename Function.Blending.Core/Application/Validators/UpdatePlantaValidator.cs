...
public class UpdatePlantaValidator : AbstractValidator<UpdatePlantaCommand>
{
    public UpdatePlantaValidator()
    {
        RuleFor(x => x.Id)
            .NotEmpty().WithMessage("El ID de la planta es requerido.");
