...
public class GetAllTipoProduccionQueryHandler : IRequestHandler<GetAllTipoProduccionQuery, PagedResponse<TipoProduccionDTO>>
{
    ...
    public async Task<PagedResponse<TipoProduccionDTO>> Handle(GetAllTipoProduccionQuery request, CancellationToken cancellationToken)
    {
        try
        {
