...
namespace Function.Blending.Core.Functions.Support.Extensions;
...
public static partial class FunctionContextExtensions
{
  ...
  /// </summary>
  public static string? GetCorrelationId(this FunctionContext ctx) => ctx.Items.TryGetValue("CorrelationId", out var v) ? v?.ToString() : null;
  ...
  /// </summary>
  public static string? GetUserObjectId(this FunctionContext ctx) => ctx.GetUser()?.GetUserId();
