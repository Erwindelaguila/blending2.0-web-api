...
using Function.Blending.Core.Infrastructure.Security.Shared.Security;
using Microsoft.Azure.Functions.Worker;
using Microsoft.Extensions.Configuration;
using FwxHttp = Microsoft.Azure.Functions.Worker.Http;

namespace Function.Blending.Core.Infrastructure.Security.Support.Security.PrincipalBuilders;
