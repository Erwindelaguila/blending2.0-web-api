...
public sealed class ToggleLogConfirmadoFunction(
  IMediator mediator,
  IProblemDetailsWriter problem,
  IRequestContext ctx)
{
  [Function(nameof(ToggleLogConfirmadoFunction))]
  [RequireScopes(ConfigurationKeys.Auth.Scopes.Logistics.ToggleConfirmed)]
  public async Task<HttpResponseData> Run(
    [HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = FunctionRoutes.Logistics.ToggleConfirmed)]
    HttpRequestData req,
