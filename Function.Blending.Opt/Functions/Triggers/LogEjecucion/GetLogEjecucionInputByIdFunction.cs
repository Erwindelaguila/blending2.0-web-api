using Function.Blending.Opt.Application.Features.LogEjecucion.Queries.GetInputById;
...
public sealed class GetLogEjecucionInputByIdFunction(
  IMediator mediator,
  IProblemDetailsWriter problem,
  IRequestContext ctx)
{
  [Function(nameof(GetLogEjecucionInputByIdFunction))]
  [RequireScopes(ConfigurationKeys.Auth.Scopes.Logistics.ReadInputById)]
  public async Task<HttpResponseData> Run(
      [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = FunctionRoutes.Logistics.GetInputById)]
      HttpRequestData req,
