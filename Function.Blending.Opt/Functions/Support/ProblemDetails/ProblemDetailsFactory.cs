...
/// <summary>
/// Implementación de RFC 7807 "application/problem+json" con soporte de extensiones.
/// Mantiene compatibilidad con tu formato previo (propiedad top-level "traceId") y añade
...
public sealed class ProblemDetailsFactory
{
  ...
  private sealed class Rfc7807Problem
  {
    ...
    // Compatibilidad hacia atrás: muchos clientes tuyos ya esperan "traceId" en top-level.
    [JsonPropertyName("traceId")] public string? TraceId { get; init; }

    // ¡Extensiones RFC 7807! Aquí puedes poner cualquier dato adicional.
    ...
    string? instance = null)
  {
    ...
    // 1) Si te pasan "errors", lo exponemos como extensión (RFC 7807 lo permite).
    ...
    if (extensions is not null)
    {
      ...
      {
        // No pisamos campos estándar; sólo agregamos extras.
  ...
  // Sobrecarga por compatibilidad (tu código anterior esperaba IDictionary<string,string[]> en "errors").
