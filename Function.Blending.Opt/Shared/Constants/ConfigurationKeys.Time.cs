...
public static partial class ConfigurationKeys
{
  public static class Time
  {
    ...
    public const string TimeZoneId = "Time:TimeZoneId";
    // Id de zona horaria específica para Windows
    public const string WindowsTimeZoneId = "Time:WindowsTimeZoneId";
    // Id de zona horaria específica para IANA
    public const string IanaTimeZoneId = "Time:IanaTimeZoneId";
  }
}
