{
  ...
  "ConnectionStrings": {
    ...
    //"BlendingDb": "Server=localhost;Initial Catalog=db_blending2_v04;Persist Security Info=False;User ID=blending_user2_04;Password=db_blending2_v04_123!;MultipleActiveResultSets=False;Encrypt=False;TrustServerCertificate=False;Connection Timeout=30;"
  },
  "Values": {
    ...
    //"SqlConnectionString_BlendingDb": "Server=localhost;Initial Catalog=db_blending2_v04;Persist Security Info=False;User ID=blending_user2_04;Password=db_blending2_v04_123!;MultipleActiveResultSets=False;Encrypt=False;TrustServerCertificate=False;Connection Timeout=30;",
    ...
    "Security_Hmac_Fallback_Enable": "true",
    //"Security_Hmac_Fallback_AllowList": "hmac-quality,hmac-logistics", //habilitar para multiples secretos separados por coma, si es que no se va a usar secretos por separado, es decir si no se va a usar "Security_Hmac_SecretsPrefix"
    "Security_Hmac_Fallback_SecretsPrefix": "Security_Hmac_Fallback_Secrets__",
    "Security_Hmac_Fallback_Secrets__quality-hmac": "CEJYMVnM88BfMGVlqlrc1Rz8IxH8KUDG4a57hx7vNYU=",
    "Security_Hmac_Fallback_Secrets__logistics-hmac": "CEJYMVnM88BfMGVlqlrc1Rz8IxH8KUDG4a57hx7vNYU=",
    ...
    "External_LogisticsModel_BaseUrl": "https://app-blending2-modelo-logistica-prod.azurewebsites.net",
    ...
    // ===== Deploy Info (for PROD) =====
    "HEALTHCHECK_INCLUDE_DEPLOY_INFO": "true"
  }
}
